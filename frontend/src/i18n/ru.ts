...
ANALYSIS_FRONTEND_PARSER_LABEL: 'UI-парсер (react-ui)',
  ANALYSIS_FRONTEND_PARSER_LABEL_ANGULAR: 'UI-парсер (angular-ui)',
  ANALYSIS_FRONTEND_PARSER_LABEL_ANGULARJS: 'UI-парсер (angularjs-ui)',
...
GRAPH_MENU_ANALYSIS: 'Структура кода',
  ...
  DOCS_MENU: 'Документация',
  DOCS_PAGE_TITLE: 'Документация',
  DOCS_PROPERTIES_TITLE: 'Свойства доков',
  DOCS_JOB_STATUS: 'Docs job',
  DOCS_JOB_NONE: 'нет',
  DOCS_ANALYSIS_RUN: 'Прогон доков',
  DOCS_CODE_JOB_STATUS: 'Code job',
  DOCS_CODE_ANALYSIS_RUN: 'Прогон кода',
  DOCS_FILE_COUNT: 'Файлов',
  DOCS_JOB_SUMMARY: 'Итог доков',
  DOCS_CODE_JOB_SUMMARY: 'Итог кода',
  DOCS_LANGUAGE: 'Язык доков',
  DOCS_DOWNLOAD_PROMPT: 'Скачать промпт доков',
  DOCS_DOWNLOAD_BUSY: 'Готовим…',
  DOCS_DOWNLOAD_CODE_PROMPT: 'Скачать промпт кода',
  DOCS_DOWNLOAD_CODE_BUSY: 'Готовим промпт кода…',
  DOCS_TREE_EMPTY: 'Файлов доков пока нет',
  DOCS_TREE_ARIA: 'Файлы документации',
  DOCS_SELECT_FILE: 'Выберите файл в дереве',
  DOCS_LOAD_ERROR: 'Не удалось загрузить документацию',
  DOCS_DOWNLOAD_ERROR: 'Не удалось скачать промпт (нужен успешный анализ)',
  DOCS_DOWNLOAD_CODE_ERROR: 'Не удалось скачать промпт кода (нужен готовый граф)',
  DOCS_CODE_DOWNLOAD_DISABLED_HINT: 'Доступно после первого успешного анализа парсерами (AGENT-CODE.md)',
  DOCS_JOB_SUCCEEDED_TOAST: 'Job доков завершён успешно',
  DOCS_CODE_JOB_SUCCEEDED_TOAST: 'Job кода завершён успешно',
  DOCS_CODE_JOB_FAILED_TOAST: 'Job кода завершён с ошибкой',
  DOCS_EXPORT: 'Экспорт',
  DOCS_EXPORT_ERROR: 'Не удалось экспортировать пакет доков',
  DOCS_EXPORT_DISABLED_HINT: 'Экспорт доступен после успешного docs job',
  openProjectForDocs: 'Откройте проект для Документации',
  GRAPH_BUILT_BY_PARSERS: 'Построено парсерами',
  GRAPH_BUILT_BY_AI: 'Построено AI',
GRAPH_UI_LOADING: 'Загрузка графа UI…',
GRAPH_UI_EMPTY: 'UI-ландшафт пуст. Парсер отсутствует или недоступен.',
GRAPH_UI_EMPTY_NO_SCREENS: 'Для этого приложения не найдены экраны или маршруты. Часто так бывает, если React-пакет без таблицы React Router, или этот ui_app — не Angular/AngularJS SPA (пустой ui_app).',
...
SYNC_PROGRESS_PREFIX: 'Синхронизация:',
SYNC_PROGRESS_PHASE_REFRESH: 'обновление рабочей копии',
SYNC_PROGRESS_PHASE_SCAN: 'индексация файлов',
SYNC_PROGRESS_PHASE_DETECT: 'определение языков',
SYNC_PROGRESS_PHASE_DONE: 'завершение',
SYNC_PROGRESS_FILES_SUFFIX: 'путей',
...
GRAPH_VIEW_SYSTEM_FILTER_LABEL: 'Фильтр связей:',
GRAPH_VIEW_SYSTEM_FILTER_ALL: 'Все',
...
GRAPH_VIEW_LAYOUT_LABEL: 'Режим раскладки:',
...
GRAPH_RESIZE_INSPECTOR: 'Изменить ширину панели свойств',
...
INSPECTOR_RELATIONSHIPS: 'Связи',
  INSPECTOR_SHOW_MORE_TEMPLATE: 'Ещё {count}',
