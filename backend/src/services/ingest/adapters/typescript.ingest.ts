...
interface TypeScriptSymbol {
  ...
  refs?: TypeScriptSymbolRef[];
}

interface TypeScriptModelV1 {
  symbols: TypeScriptSymbol[];
}

export const typescriptIngestAdapter: IngestAdapter = {
  parser_id: 'typescript',
  supported_schema_versions: ['1'],

  transform(model: unknown, ctx: IngestContext): IngestTransformResult {
    const parsed = model as TypeScriptModelV1;
