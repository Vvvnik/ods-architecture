...
- полноценный graph viewer (React Flow, интерактивный layout) — post-MVP;
...
- Graphify (`007`): не смешивать с каноном языковых парсеров в UI первой итерации.
...
- Graphify (`007`) — отдельный канал; не объединять с каноном парсеров в UI v1.
